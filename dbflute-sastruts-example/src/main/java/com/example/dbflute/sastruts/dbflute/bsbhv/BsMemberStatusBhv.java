...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberStatus> ENTITY doSelectByPKValue(CDef.MemberStatus memberStatusCode, Class<ENTITY> entityType) {
    ...
    protected <ENTITY extends MemberStatus> ENTITY doSelectByPKValueWithDeletedCheck(CDef.MemberStatus memberStatusCode, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(buildPKCB(memberStatusCode), entityType);
    }

    private MemberStatusCB buildPKCB(CDef.MemberStatus memberStatusCode) {
