 ...
 */
package com.example.dbflute.sastruts.dbflute.bsbhv;
...
import com.example.dbflute.sastruts.dbflute.bsbhv.loader.*;
import com.example.dbflute.sastruts.dbflute.exentity.*;
import com.example.dbflute.sastruts.dbflute.bsentity.dbmeta.*;
...
public abstract class BsProductStatusBhv extends AbstractBehaviorWritable<ProductStatus, ProductStatusCB> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SummaryProduct> loadSummaryProductList(List<ProductStatus> productStatusList, ConditionBeanSetupper<SummaryProductCB> setupper) {
        xassLRArg(productStatusList, setupper);
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SummaryProduct> loadSummaryProductList(ProductStatus productStatus, ConditionBeanSetupper<SummaryProductCB> setupper) {
        xassLRArg(productStatus, setupper);
    ...
    protected <RESULT extends ProductStatus> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.sastruts.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }
    ...
    protected <RESULT extends ProductStatus> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.sastruts.dbflute.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }
