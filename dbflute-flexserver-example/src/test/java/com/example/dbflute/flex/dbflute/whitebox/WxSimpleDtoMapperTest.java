...
import com.example.dbflute.flex.dbflute.cbean.PurchaseCB;
...
import com.example.dbflute.flex.dbflute.exentity.MemberSecurity;
import com.example.dbflute.flex.dbflute.exentity.MemberStatus;
import com.example.dbflute.flex.dbflute.exentity.MemberWithdrawal;
import com.example.dbflute.flex.dbflute.exentity.Purchase;
import com.example.dbflute.flex.simpleflute.dto.MemberDto;
import com.example.dbflute.flex.simpleflute.dto.MemberSecurityDto;
...
public class WxSimpleDtoMapperTest extends UnitContainerTestCase {
    ...
    public void test_mappingToDto_ManyToOne_Tx() throws Exception {
        ...
        for (Member member : memberList) {
            ...
            // ## Assert ##
            log(dto.getMemberId() + ", " + dto.getMemberStatus());
            assertEqualsMember(member, dto);
            assertNotNull(dto.getMemberStatus());
        }
    }
    ...
    public void test_mappingToDtoList_noPK_Tx() throws Exception {
        ...
        for (Member member : memberList) {
            ...
            member.getMemberStatus().setMemberStatusCode(null);
    ...
    public void test_mappingToEntityList_ManyToOne_Tx() throws Exception {
        // ## Arrange ##
        final MemberCB cb = new MemberCB();
        cb.setupSelect_MemberStatus();
        final ListResultBean<Member> memberList = memberBhv.selectList(cb);
