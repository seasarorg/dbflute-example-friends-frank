...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, true, "memberId", Integer.class, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_F36C73A4_3C67_4C27_8EDB_E1EB806678AD", false, null, null, "memberLoginAsLatest,memberSecurityAsOne,memberServiceAsOne,memberWithdrawalAsOne", "memberAddressList,memberLoginList,purchaseList", null);
    ...
    public ForeignInfo foreignMemberLoginAsLatest() {
        ...
        return cfi("FK_MEMBER_LATEST_LOGIN", "memberLoginAsLatest", this, MemberLoginDbm.getInstance(), map, 1, true, true, false, true, "$$foreignAlias$$.LOGIN_DATETIME = (select max(LOGIN_DATETIME) from MEMBER_LOGIN where MEMBER_ID = $$localAlias$$.MEMBER_ID)", null, false, null);
    }
