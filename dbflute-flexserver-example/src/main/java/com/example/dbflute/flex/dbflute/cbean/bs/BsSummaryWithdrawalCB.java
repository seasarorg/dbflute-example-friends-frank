package com.example.dbflute.flex.dbflute.cbean.bs;
...
import com.example.dbflute.flex.dbflute.allcommon.DBFluteConfig;
import com.example.dbflute.flex.dbflute.allcommon.DBMetaInstanceHandler;
import com.example.dbflute.flex.dbflute.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.flex.dbflute.allcommon.ImplementedSqlClauseCreator;
...
public class BsSummaryWithdrawalCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;SummaryWithdrawalCB&gt;() {
    ...
    public void union(UnionQuery<SummaryWithdrawalCB> unionQuery) {
        final SummaryWithdrawalCB cb = new SummaryWithdrawalCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;SummaryWithdrawalCB&gt;() {
     *     public void query(SummaryWithdrawalCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;SummaryWithdrawalCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;SummaryWithdrawalCB&gt;() {
     ...
     *     public void query(SummaryWithdrawalCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SummaryWithdrawalCB&gt;() {
